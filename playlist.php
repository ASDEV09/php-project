...
VALUES (:user_id, :media_id, :rating, :review_text, current_timestamp())";
            ...
            <h1 class="text-white mb-3"><?php echo "Playlist"; ?></h1>
            <div class="row">
                <?php
                include('config/db.php');
                $sql = "SELECT m.media_id, m.title AS song_title, m.duration, m.file_path, m.pic_url 
                FROM Media m 
                INNER JOIN playlists p ON m.media_id = p.media_id 
                WHERE p.user_id = ?";
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="card">
                                ...
                                <div class="card-body text-white bg-black">
                                    ...
                                    <button style=" background-color:#FEA506;color:#fff" class="btn btn-delete-to-playlist" data-media-id="<?php echo $row['media_id']; ?>">
                                        <i style=" background-color:#FEA506;color:#fff" class="fas fa-minus"></i>
                                    </button>
                                    <br>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('.btn-delete-to-playlist').on('click', function() {
                var mediaId = $(this).data('media-id');
                var confirmation = confirm("Are you sure you want to delete this song from your playlist?");
                ...
                if (confirmation) {
                    $.ajax({
                        ...
                        success: function(response) {
                            alert('Song deleted from playlist successfully.');
                            location.reload();
                        },
                        error: function() {
