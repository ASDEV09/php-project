...
<head>
    ...
    <title>Music Player - Genre Song</title>
...
VALUES (:user_id, :media_id, :rating, :review_text, current_timestamp())";
    ...
    if (isset($_GET['genre_id'])) {
        ...
        $sql_artist = "SELECT genre_name , genre_pic FROM genres WHERE genre_id = ?";
        ...
        if ($result_artist->num_rows > 0) {
            ...
            $genre_name = htmlspecialchars($row_artist['genre_name']);
            $genre_image = htmlspecialchars($row_artist['genre_pic']);
        }
    }
    ?>
    ...
    <div class="content-wrapper">
        ...
        <h1 class="text-white mb-3"><?php echo $genre_name; ?></h1>
        <?php endif; ?>
        ...
        <div class="container">
            <div class="row">
                ...
                if (isset($_GET['genre_id'])) {
                    ...
                    $sql = "SELECT m.media_id, m.title as song_title, m.duration, a.genre_name, a.genre_pic, m.file_path, m.pic_url, a.genre_id, art.artist_name 
        FROM Media m 
        left JOIN genres a ON m.genre_id = a.genre_id 
        left JOIN artists art ON m.artist_id = art.artist_id 
        WHERE m.type = 'Music' AND m.genre_id = ?";
                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            ...
                            $genre_idd = htmlspecialchars($row['genre_id']);
                            ...
                            $image_url = $row['genre_pic'];
                            $pic_url = $row['pic_url'];
                            $file_path = $row['file_path'];
                ?>
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="card">
                        <img src="<?php echo $pic_url; ?>" class="card-img-top" alt="<?php echo $genre_name; ?>">
                        <div class="card-body text-white bg-black">
                            ...
                            <button class="play-button btn hr" style="width: 80px; background-color:#FEA506;color:#fff"
                                data-file-path="<?php echo $file_path; ?>" data-artist="<?php echo $genre_name; ?>"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div style="background-color: #000;color:#fff" class="modal-body">
                                ...
                                <form action="genreplay.php?genre_id=<?php echo $genre_id; ?>" method="post">
    ...
    $(document).ready(function() {
        ...
        $('.btn-add-to-playlist').on('click', function() {
            ...
            var genre_id = <?php echo json_encode($genre_id); ?>;
            $.ajax({
                type: 'POST',
                url: 'genreplay.php',
                data: {
