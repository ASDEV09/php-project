...
<head>
    ...
    <title>Music Player | Album</title>
    <!-- Bootstrap CSS -->
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div style="background-color: #000;color:#fff" class="modal-body">
                                        ...
                                        <form action="albums.php?search=<?php echo$searchTerm?>" method="post">
...
?>
            ...
            <h1 class="my-4 text-center" style="color:#bfbfbf;">Albums</h1>
            <div class="roww">
                <?php
            include('config/db.php');
            
            $sql = "SELECT album_id, album_title, album_cover_url FROM albums";
            ...
            if ($result->num_rows > 0) {
                while($row = $result->fetch_assoc()) {
                    ...
                    echo "<div style='margin-right:-40px' class='col-lg-4 col-md-6 col-sm-12 mb-4'>";
                    echo "<div class='cards text-center'>";
                    echo "<a href='albumplay.php?album_id=" . $album_id . "'>";
                    echo "<img  src='" . $album_cover_url . "' class='card-img-top album-card' alt='" . $album_title . "'>";
                    echo "<div class='d card-body'>";
                    echo "<h5  class='card-title'>" . $album_title . "</h5>";
                    echo "</div>";
                    echo "</a>";
