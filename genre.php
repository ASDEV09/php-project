            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
                <div class="card">
                    ...
                    <div class="card-body text-white bg-black">
                        ...
                        <br> <button style="margin-top: 10px; background-color: black; color: #fff; border: none;"
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div style="background-color: #000;color:#fff" class="modal-body">
                                        ...
                                        <form action="genre.php?search=<?php echo$searchTerm?>" method="post">
...
?>
            ...
            <h1 class="my-4 text-center" style="color:#bfbfbf;">Genre</h1>
            <div class="roww">
                <?php
            include('config/db.php');
            
            $sql = "SELECT genre_id, genre_name, genre_pic FROM genres ";
            ...
            if ($result->num_rows > 0) {
                while($row = $result->fetch_assoc()) {
                    ...
                    $genre_pic = $row["genre_pic"];

                    echo "<div class='col-lg-4 col-md-6 col-sm-12 mb-4'>";
                    echo "<div class='cards text-center'>";
                    echo "<a href='genreplay.php?genre_id=" . $genre_id . "'>";
                    echo "<img src='" . $genre_pic . "' class='card-img-top rounded-circle' alt='" . $genre_name . "'>";
                    echo "<div class='d card-body'>";
                    echo "<h5  class=' card-title'>" . $genre_name . "</h5>";
                    echo "</div>";
                    echo "</a>";
                    echo "</div>";
                    echo "</div>";
                ...
                echo "<div class='alert alert-warning text-center'>We couldn't find any songs for this Genre..</div>";
                echo "</div>";
            }
